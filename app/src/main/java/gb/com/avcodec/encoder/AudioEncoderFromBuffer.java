 ...
 * <p/>
 * 作者：Administrator on 2017/6/23 17:02
 * <p/>
 * 邮箱：xjs250@163.com
 * <p/>
 * 创建日期：2017/6/23 17:02
 * <p/>
 * 描述：
 * =====================================================================================
 */
public class AudioEncoderFromBuffer implements Runnable {
...
//    public AudioEncoderFromBuffer(WeakReference<MediaMuxerUtils> muxerRunnableRf){
...
//    }
    ...
    private void initMediaCodec() {
        ...
        String fileName = FILE_NAME_BASE+"VVID_"+System.currentTimeMillis()+".mp4";
        ...
        if(inputBufferIndex >= 0){
            ...
            if(audioBuf==null || readBytes<=0){
              mAudioEncoder.queueInputBuffer(inputBufferIndex,0,0,getPTSUs(),MediaCodec.BUFFER_FLAG_END_OF_STREAM);
                //mAudioEncoder.queueInputBuffer(inputBufferIndex, 0, audioBuf.length, System.nanoTime() / 1000, 0);
            }else{
                Log.e(TAG, "encoderBytes: ------>>编码数据" );
                inputBuffer.clear();
